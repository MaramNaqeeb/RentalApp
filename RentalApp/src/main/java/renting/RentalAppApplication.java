...
public class RentalAppApplication {
	...
	public static void main(String[] args) {
		...
		Building apartment = owner.addBuilding(new Apartment("87 rdt St", "White Apartments", 200, 1000, 2003));
		Building house = owner.addBuilding(new House("965 Sun St", "Holiday House", 300, 2800, 2008));
		Building house2 = owner.addBuilding(new House("832 Wr St", "Winter House", 500, 28000, 2008));
		Building shop = owner.addBuilding(new Shop("563 Noe St", "Book Shop", 500, 800, 2005));
		Building shop2 = owner.addBuilding(new Shop("563 Noe St", "Clothes Shop", 500, 800, 2005));
