...
public class RentalAppApplication {
	...
	public static void main(String[] args) {
		...
		Building apartment = owner1
				.addBuilding(new Apartment("White Apartments", "87 rdt St", 200, 1000, 2003, owner1.getName()));
		Building house = owner2
				.addBuilding(new House("Holiday House", "965 Sun St", 300, 2800, 2008, owner2.getName()));
		Building house2 = owner1
				.addBuilding(new House("Winter House", "832 Wr St", 500, 28000, 2008, owner1.getName()));
		Building shop = owner3.addBuilding(new Shop("Book Shop", "563 Noe St", 500, 800, 2005, owner3.getName()));
		Building shop2 = owner2.addBuilding(new Shop("Clothes Shop", "563 Noe St", 500, 800, 2005, owner1.getName()));
		...
		owner1.viewRentedBuildings(customers);
